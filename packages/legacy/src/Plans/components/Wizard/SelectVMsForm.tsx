...
import { FilterToolbar, FilterType, FilterCategory } from '@kubev2v/legacy/common/components/FilterToolbar';
...
import { getVMPowerState, VMNameWithPowerState } from '@kubev2v/legacy/common/components/VMNameWithPowerState';
