...
import { getMostSeriousCondition, getStatusType } from 'src/common/helpers';
import { StatusCategoryType } from 'src/common/constants';
import { IStatusCondition } from 'src/queries/types';
