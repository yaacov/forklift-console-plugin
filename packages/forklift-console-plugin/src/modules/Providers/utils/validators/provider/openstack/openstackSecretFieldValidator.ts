...
const validateRegionName = (value: string): ValidationMsg => {
  ...
  if (valid) {
    return { type: 'default', msg: 'OpenStack region name.' };
  }
...
const validateProjectName = (value: string): ValidationMsg => {
  ...
  if (valid) {
    return { type: 'default', msg: 'OpenStack project name.' };
  }
...
const validateDomainName = (value: string): ValidationMsg => {
  ...
  if (valid) {
    return { type: 'default', msg: 'OpenStack domain name.' };
  }
...
const validateToken = (value: string): ValidationMsg => {
  ...
  if (valid) {
    return { type: 'default', msg: 'OpenStack token for authentication using a user name.' };
  }
...
const validateProjectID = (value: string): ValidationMsg => {
  ...
  if (valid) {
    return { type: 'default', msg: 'OpenStack project ID.' };
  }
